        ...
        <div className="drawer-side">
            ...
            <div className="w-64 bg-base-200 p-2 h-screen">
                <ul className="menu w-full">
                    ...
                    <li><Link to="/links" className={`text-lg font-semibold mb-2 ${location.pathname === "/links" ? "active" : ""}`}><FontAwesomeIcon icon={faLink} className="mr-2" />All Links<span className="badge badge-neutral">99+</span></Link></li>
                    <li><Link to="/collections" className={`text-lg font-semibold mb-2 ${location.pathname === "/collections" ? "active" : ""}`}><FontAwesomeIcon icon={faFolder} className="mr-2" />Collections<span className="badge badge-neutral">99+</span></Link></li>
